...
jsmpeg.prototype.initSocketClient = function(even) {
...
jsmpeg.prototype.decodeSocketHeader = function( data ) {
	...
	if(
		data[0] === SOCKET_MAGIC_BYTES[0] &&
		data[1] === SOCKET_MAGIC_BYTES[1] &&
		data[2] === SOCKET_MAGIC_BYTES[2] &&
		data[3] === SOCKET_MAGIC_BYTES[3]
	) {
